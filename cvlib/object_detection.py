...
def populate_class_labels():
    ...
    # we are using yolov3 classfiier which is more efficient than the model which we could 
    #have trained on our own loptop
    # the classfier should be downloaded automatically when this script is runn

    class_file_name='yolo_classes.txt'
...
def get_output_layers(net):
    ...
    layer_names=net.getLayersNames()
